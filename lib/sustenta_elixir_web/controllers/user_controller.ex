defmodule SustentaElixirWeb.UserController do
  use SustentaElixirWeb, :controller

  import SustentaElixirWeb.Authorize

  alias Phauxth.Log
  alias SustentaElixir.{Accounts, Accounts.User}
  alias SustentaElixirWeb.{Auth.Token, Email}
