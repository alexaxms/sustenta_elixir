defmodule SustentaElixirWeb.PasswordResetControllerTest do
  use SustentaElixirWeb.ConnCase

  import SustentaElixirWeb.AuthCase

  @update_attrs %{email: "gladys@example.com", password: "^hEsdg*F899"}

  setup %{conn: conn} do
    conn = conn |> bypass_through(SustentaElixirWeb.Router, :browser) |> get("/")
